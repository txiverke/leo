...
1. Einführung:&nbsp;
          ...
          <p className="txt">
            <li className="app-olist-item">
            <strong className="txt-highlight">
          5. Erhebung und Speicherung personenbezogener Daten </strong> sowie Art und Zweck von deren Verwendung Beim Besuch der Website Beim Aufrufen unserer Webseiten werden durch den auf Ihrem Endgerät zum Einsatz
          kommenden Browser automatisch Informationen an den Server unserer
          Website gesendet. Diese Informationen werden temporär in einer sog.
          ...
          iv. Website, von der aus der Zugriff erfolgt (Referrer-URL),
          v. verwendeter Browser und ggf. das Betriebssystem Ihres Rechners
          sowie der Name Ihres Access-Providers.
          Die genannten Daten werden durch uns zu folgenden Zwecken verarbeitet:
          vi. Gewährleistung eines reibungslosen Verbindungsaufbaus der Website,
          vii. Gewährleistung einer komfortablen Nutzung unserer Website,
          viii. Auswertung der Systemsicherheit und -stabilität sowie
          ix. zu weiteren administrativen Zwecken.
          ...
          ziehen. Darüber hinaus setzen wir beim Besuch unserer Website Cookies
          sowie Analysedienste ein. Nähere Erläuterungen dazu erhalten Sie unter
          ...
          c) für den Fall, dass für die Weitergabe nach Art. 6 Abs. 1 S. 1 lit.
          ...
          eine Google-Anzeige auf unsere Webseite gelangt sind.
          ...
          nicht über die Webseiten von Adwords-Kunden nachverfolgt werden. Die
          ...
          generell deaktiviert. Sie können Cookies für Conversion-Tracking auch
          ...
          Webseite. Dadurch wird Ihre IPAdresse von Google jedoch innerhalb von
          ...
          statistischen Auswertung der Nutzung der Website. Hierzu werden
          Cookies eingesetzt (siehe Ziffer 4). Die durch den Cookie erzeugten
          Informationen über die Websitenutzung werden an unsere Server
          übertragen und in pseudonymen Nutzungsprofilen zusammengefasst. Die
          Informationen werden verwendet, um die Nutzung der Website auszuwerten
          und um eine bedarfsgerechte Gestaltung unserer Website zu ermöglichen.
          Eine Weitergabe der Informationen an Dritte erfolgt nicht.
          Es wird in keinem Fall die IP-Adresse mit anderen den Nutzer
          betreffenden Daten in Verbindung gebracht. Die IP-Adressen werden
          ...
          erfasst. Klicken Sie hier (https://matamo.org/docs/privacy/), damit
          ...
          b. gemäß Art. 16 DSGVO unverzüglich die Berichtigung unrichtiger oder
          ...
          e. gemäß Art. 20 DSGVO Ihre personenbezogenen Daten, die Sie uns
          bereitgestellt haben, in einem strukturierten, gängigen und
          maschinenlesebaren Format zu erhalten oder die Übermittlung an einen
          anderen Verantwortlichen zu verlangen;
          f. gemäß Art. 7 Abs. 3 DSGVO Ihre einmal erteilte Einwilligung
          ...
          Firmensitzes wenden.
          Sie haben das das Recht, die Sie betreffenden personenbezogenen Daten,
          ...
          Art. 6 Abs. 1 lit. b DS-GVO beruht und die Verarbeitung mithilfe
          ...
          betreffenden personenbezogenen Daten gegen die DS-GVO verstößt. Die
          ...
          rechtlichen Verpflichtung erforderlich ist, denen unser Unternehmen
          unterliegt, dient Artikel 6 Absatz 1 lit. c DSGVO als Rechtsgrundlage.
          ...
          personenbezogener Daten erforderlich machen, dient Artikel 6 Absatz 1
          ...
          erstgenannte Interesse nicht, so dient Artikel 6 Absatz 1 lit. f DSGVO
